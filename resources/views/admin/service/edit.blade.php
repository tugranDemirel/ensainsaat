...
@section('title',  'Servis-Hizmet Düzenle')
@section('styles')
    ...
    <div class="page-body">
        ...
        <div class="clearfix">
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane fade in active" id="basic_info">
                        <div class="form-group">
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" name="short_description" value="{{ $service->short_description }}" class="form-control @error('short_description') is-invalid @enderror"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="description" name="description" class="form-control @error('description') is-invalid @enderror editor1" rows="5">{!! $service->description !!}</textarea>
                        </div>
                </div>
                <!-- #END# Basic Info -->
                <!-- Detail Info -->
                ...
                <div role="tabpanel" class="tab-pane fade" id="meta_data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea rows="6" class="form-control no-resize" name="meta_description">{{ $service->meta_description ?? '' }}</textarea>
                        </div>
                </div>
                <!-- #END# Meta Data -->
                <!-- Product Images -->
            ...
            <div class="m-t-10 m-b-20 pull-right">
                <button class="btn btn-sm btn-success"><i class="fa fa-save m-r-5"></i>Düzenle</button>
            </div>
            </form>
        </div>
    </div>
